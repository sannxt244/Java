...
public class updateLessonServlet extends BaseAuthController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        list = dao.LessonById(id);
        request.setAttribute("listlessonbyid", list);
    ...
    protected void processPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Lesson l= new Lesson(name, video, content, type, order);
        lessonDAO lesson=new lessonDAO();

        
        lesson.updateLesson(id, l);
