                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <c:forEach items="${quizList}" var="o">                                       
                                            <tr>
                                                ...
                                                <td>${o.level}</td>
                                                <td>
                                                    <a href="AdminQuizDetailServlet?quizId=${o.id}"  class="btn btn-primary">Update</a>
                                                    <a href="DeletteQuiz?pid=${o.id}"  class="btn btn-primary">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
