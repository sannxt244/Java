...
<html>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="${pageContext.request.contextPath}/AdminQuizListServlet">Return to Quiz List</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                ...
                <form action="AddQuizFormatServlet" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="quiz_number" class="form-control form-control-lg " id=" formGroupExampleInput2" placeholder="Input Lesson Name">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="col-form-label-lg">Quiz Type</label>
                        <input type="text" name="quiz_type" class="form-control form-control-lg " id=" formGroupExampleInput2" placeholder="Input Lesson Name">
                    </div>
                    <br>
