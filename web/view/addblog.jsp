...
<html>
    ...
    <body>
        <div class="main h-100 " >
            ...
            <div class="main-content mt-2 h-100">
                <div class="container-fluid h-100 ">

                    <div class=" row d-flex justify-content-center align-items-center h-100">                       
                        <div class="col-md-6 card shadow-lg bg-white rounded">
                            <h3 class="text-center font-weight-bold">Add new blog</h3>
                            <form class="card-body Form-postDetail" action="addblog" method="POST" enctype="multipart/form-data">
