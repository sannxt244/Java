    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <form action="AddQuizFormatServlet" method="POST">
                    <main>
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Add a new Quiz Format</h1>
                        </div>
                    </main>
                    ...
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="col-form-label-lg">Quiz Subject</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="quiz_name" class="form-control form-control-lg " id=" formGroupExampleInput2" placeholder="Input Lesson Name">
                    </div>

                    <br>
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="col-form-label-lg">Quiz Duration</label>
                        <input type="number" value="${quizFormat.duration}" name="quiz_Duration" class="form-control form-control-lg " id=" formGroupExampleInput2" placeholder="Input Duration">
                    </div>
                    <br>               
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="col-form-label-lg">Quiz Number</label>
                        <input type="number " name="quiz_number" class="form-control form-control-lg " id=" formGroupExampleInput2" placeholder="Input Number">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="col-form-label-lg">Quiz Type</label>
                        <input type="text" value="Quiz" name="quiz_type" class="form-control form-control-lg " readonly id=" formGroupExampleInput2" placeholder="Input Type">
                    </div>
                    <br>
