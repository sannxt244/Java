<%-- 
    ...
    Created on : Jul 20, 2022, 1:53:40 AM
    Author     : HDC
--%>
                        ...
                        <div class="col-md-10 ">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${requestScope.myregistrations}" var="y">
                                        <tr>
                                            <td>${y.name}</td>
                                            <td>${y.date}</td>
                                            <td>${y.package_name}</td>
                                            <td>${y.state}</td>
                                            <td>
                                                <a href="changeMyregistrationServlet?course=${y.id}">Huy dang ky</a>
                                            </td>
                                            <th scope="col"></th>
                                        </tr>
                                    </c:forEach>
